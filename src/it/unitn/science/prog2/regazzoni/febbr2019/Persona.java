...
public class Persona extends Record {
    ...
    Persona () {
        super (Pos.TOP_RIGHT);
        lista = stampa();
        aggiungi.setText("Nuova persona");
        ordinaPerF3.setText("Ordina per anno di nascita");
    }
    
    Persona (String nome, String cognome, Integer annoNascita) {
        super(nome, cognome, annoNascita);
    }
    
    @Override
    public void add (String nome, String cognome, Integer anno) {
        list.add(new Persona (nome, cognome, anno));
    } 
    ...
    @Override
    public int conta() {
        System.out.println(list.size()+" persone");
        return list.size();
    }
    ...
    GridPane tab = new GridPane ();
        Label text1 = new Label ("Nome:    ");
        tab.add(text1, 0, 0);
        TextField tf1 = new TextField ();
        tab.add(tf1, 1, 0);
        //String marca = tf1.getText();
        Label text2 = new Label ("Cognome:  ");
        tab.add(text2, 0, 1);
        TextField tf2 = new TextField ();
        tab.add(tf2, 1, 1);
        //String modello = tf2.getText();
        Label text3 = new Label ("Anno:   ");
        tab.add(text3, 0, 2);
    ...
    private boolean controlla (String a, String b, String c) {
        ...
        for (Persona pers : list) {
            if (pers.equals(new Persona (a, b, i))) return false;
